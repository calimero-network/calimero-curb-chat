    ...
    <ChannelListContainer>
      <ScrollableChannelList>
        {channels.map((channel) => {
          const isSelected = selectedChannelId === channel.name;
          const hasUnread = channel.unreadMessages.count > 0;
          const hasMentions = channel.unreadMessages.mentions > 0;
              ...
              {isCollapsed ? (
                <IconWrapper style={{ opacity: isSelected ? 0.9 : 0.5 }}>
                  {channel.channelType === "Private" ? (
                    ...
                    <svg width="10" height="13" viewBox="0 0 13 17" xmlns="http://www.w3.org/2000/svg">
